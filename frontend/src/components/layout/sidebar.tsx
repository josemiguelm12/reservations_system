...
export function Sidebar() {
  ...
  return (
    <aside className="hidden lg:flex flex-col w-[var(--sidebar-width)] bg-[var(--sidebar-bg)] border-r border-[var(--border)] min-h-screen fixed top-0 left-0 z-30">
      {/* User profile section */}
      <div className="px-5 pt-6 pb-4">
        <div className="flex items-center gap-3">
          <div className="h-10 w-10 rounded-full bg-gradient-to-br from-[var(--primary)] to-blue-400 flex items-center justify-center text-white text-sm font-semibold shadow-md">
            {initials}
          </div>
          <div className="flex-1 min-w-0">
            ...
            <p className="text-xs text-[var(--muted-foreground)]">Premium Member</p>
          </div>
        </div>
      </div>
      ...
      {/* Bottom links */}
      <div className="px-3 pb-5 space-y-0.5 border-t border-[var(--border)] pt-3">
